...
<head>
    ...
    <meta name="description" content="Turn raw product info into a complete, persuasive sales page in seconds. Headlines, benefits, pricing, CTAs — all written by AI, exported as HTML.">
    ...
    <nav class="sticky top-0 z-50 bg-ivory/85 backdrop-blur border-b-2 border-ink">
        <div class="max-w-7xl mx-auto px-5 md:px-8 h-16 flex items-center justify-between">
            <a href="/" class="flex items-center gap-2.5">
                <div class="w-8 h-8 rounded-lg bg-lime border-2 border-ink flex items-center justify-center font-display font-bold text-ink">
                    S
                </div>
                <span class="font-display text-xl font-bold tracking-tight">Sales<em class="not-italic text-salmon">Forge</em></span>
            </a>
    ...
    <section class="relative overflow-hidden grain border-b-2 border-ink">
        <div class="max-w-7xl mx-auto px-5 md:px-8 pt-10 pb-14 md:pt-16 md:pb-20 grid grid-cols-12 gap-6">
            ...
            <div class="col-span-12 lg:col-span-7 relative">
                <span class="eyebrow mb-5">Option B / Sales Page Generator</span>
                ...
                <p class="mt-7 text-lg md:text-xl text-ink/75 max-w-xl leading-relaxed">
                    Drop in a name, a description, features, audience and price. Our AI returns a structured landing page — headline, benefits, pricing, CTA — rendered live, edit-able, exportable.
                </p>

                <div class="mt-7 flex flex-wrap gap-3">
                    <a href="{{ route('register') }}" class="btn-accent text-base px-7 py-3.5">
                        Forge a page
                        <svg class="w-4 h-4 ml-2" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M17 8l4 4-4 4M3 12h18"/></svg>
                    </a>
                    <a href="#how" class="btn-secondary text-base px-7 py-3.5">See how</a>
                </div>

                <div class="mt-8 flex flex-wrap items-center gap-x-6 gap-y-2 text-xs font-mono uppercase tracking-[0.16em] text-ink/60">
                    <span class="flex items-center gap-1.5"><span class="w-2 h-2 rounded-full bg-lime border border-ink"></span> Free, no card</span>
                    <span class="flex items-center gap-1.5"><span class="w-2 h-2 rounded-full bg-salmon border border-ink"></span> 3 templates</span>
                    <span class="flex items-center gap-1.5"><span class="w-2 h-2 rounded-full bg-ink"></span> HTML export</span>
                </div>
            </div>
            ...
            <div class="col-span-12 lg:col-span-5 relative">
                ...
                <div class="card-flat bg-ivory-50 p-5 shadow-brutal-lg rotate-[1.5deg]">
                    ...
                    <div class="flex items-center gap-1.5 mb-3">
                        ...
                        <span class="ml-3 px-3 py-1 rounded-full text-[10px] font-mono bg-ivory-100 border border-ink/20">salesforge.app/preview</span>
                    </div>
                    {{-- mock page --}}
                    <div class="space-y-3">
                        ...
                        <p class="text-xs text-ink/65 leading-relaxed">Real-time sync for teams who refuse to wait. Built for distributed product squads.</p>
                        <div class="grid grid-cols-3 gap-2 pt-1">
                            <div class="bg-lime/40 border border-ink rounded-lg p-2 text-[10px] font-bold">Real-time sync</div>
                            <div class="bg-ivory-100 border border-ink rounded-lg p-2 text-[10px] font-bold">99.9% uptime</div>
                            <div class="bg-salmon/40 border border-ink rounded-lg p-2 text-[10px] font-bold">API access</div>
                        </div>
                        <div class="flex items-end justify-between pt-2 border-t border-ink/15">
                            ...
                            <div class="bg-ink text-ivory text-[10px] font-bold px-3 py-2 rounded-full">Start trial →</div>
                        </div>
                    </div>
                </div>

                {{-- floating chips --}}
                <div class="hidden md:block absolute -left-6 top-10 bg-ivory-50 border-2 border-ink rounded-full px-4 py-2 shadow-brutal -rotate-6">
                    <span class="text-xs font-mono font-bold">⚡ 1.4s avg gen</span>
                </div>
                <div class="hidden md:block absolute -bottom-4 -left-2 bg-lime border-2 border-ink rounded-2xl px-4 py-3 shadow-brutal rotate-3">
    ...
    <section id="how" class="border-b-2 border-ink bg-ivory-50">
        <div class="max-w-7xl mx-auto px-5 md:px-8 py-14 md:py-20">
            <div class="flex items-end justify-between flex-wrap gap-4 mb-10">
                ...
                <p class="text-ink/65 max-w-md">No design skills needed. No copywriting headaches. Just product info in, sales page out.</p>
            </div>
            ...
            <div class="grid grid-cols-12 auto-rows-[minmax(160px,auto)] gap-4">
                ...
                <div class="col-span-12 md:col-span-7 row-span-2 card-dark p-7 relative overflow-hidden">
                    ...
                    <h3 class="h-display text-4xl md:text-5xl mt-5 text-ivory">
                        Persuasive copy,<br><em class="text-lime not-italic" style="font-style:italic;">written for you</em>.
                    </h3>
                    <p class="mt-4 text-ivory/70 max-w-md leading-relaxed">Each generated page includes a compelling headline, sub-headline, product description, benefits, features breakdown, social proof, pricing display and a clear call-to-action.</p>
                ...
                <div class="col-span-12 md:col-span-3 card p-6">
                    <div class="w-10 h-10 rounded-xl bg-salmon border-2 border-ink flex items-center justify-center mb-3">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="2.2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M4 16v2a2 2 0 002 2h12a2 2 0 002-2v-2M7 10l5 5 5-5M12 15V3"/></svg>
                    </div>
                ...
                <div class="col-span-12 md:col-span-2 card p-5 bg-ink text-ivory">
                    <svg class="w-7 h-7 text-lime mb-2" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15"/></svg>
                ...
                <div class="col-span-12 md:col-span-4 card p-6">
                    ...
                    <p class="text-sm text-ink/70 mt-1.5 leading-relaxed">See the rendered page exactly as visitors will. No raw text dumps.</p>
                </div>
                ...
                <div class="col-span-12 md:col-span-4 card p-6 bg-salmon/30">
                    ...
                    <p class="text-sm text-ink/70 mt-1.5 leading-relaxed">Each account only sees its own pages. Auth-gated CRUD.</p>
                </div>
        ...
        <div class="max-w-7xl mx-auto px-5 md:px-8 py-14 md:py-20 relative z-10">
            <div class="flex items-end justify-between flex-wrap gap-4 mb-10">
                <div>
                    ...
                    <h2 class="h-display text-5xl md:text-6xl mt-3 text-ivory">Sample <em class="text-lime" style="font-style:italic;">outputs</em>.</h2>
                </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
                ...
                @foreach($samples as $i => $sm)
                    <div class="bg-ivory-50 text-ink rounded-2xl border-2 border-ink p-5 shadow-brutal-lime hover:translate-x-[-2px] hover:translate-y-[-2px] hover:shadow-brutal-lg transition-transform">
                        <div class="flex items-center justify-between mb-3">
                            <span class="badge-mono text-[10px]">{{ $sm['tmpl'] }}</span>
                            <span class="text-[10px] font-mono text-ink/60 uppercase tracking-widest">{{ $sm['tag'] }}</span>
                        </div>
                        ...
                        <div class="flex items-center justify-between pt-4 mt-4 border-t border-ink/15">
                            ...
                            <span class="bg-ink text-ivory text-[10px] font-bold px-3 py-1.5 rounded-full">{{ $sm['cta'] }} →</span>
                        </div>
                    </div>
                @endforeach
            </div>
        ...
        <div class="max-w-7xl mx-auto px-5 md:px-8 py-16 md:py-24 grid grid-cols-12 gap-6 relative">
            ...
            <div class="col-span-12 md:col-span-4 flex md:justify-end items-end">
                <div class="bg-ink text-ivory rounded-2xl border-2 border-ink p-5 -rotate-2 shadow-brutal max-w-xs">
                    ...
                    <p class="font-display text-xl leading-snug mt-2">"Forged a launch page over coffee. Shipped before lunch."</p>
    ...
    <footer class="bg-ink text-ivory">
        <div class="max-w-7xl mx-auto px-5 md:px-8 py-8 flex flex-col md:flex-row items-center justify-between gap-4">
            <div class="flex items-center gap-2.5">
                <div class="w-7 h-7 rounded-md bg-lime border-2 border-lime flex items-center justify-center font-display font-bold text-ink">S</div>
                <span class="font-display text-lg font-bold tracking-tight">Sales<em class="not-italic text-salmon">Forge</em></span>
            </div>
            <p class="text-xs text-ivory/55 font-mono uppercase tracking-widest">© {{ date('Y') }} — Built for Option B</p>
        </div>
    </footer>
